...
class CreateUserForm(forms.ModelForm):
  login = forms.CharField(label=_('Nombre de Usuario'),max_length=30, error_messages = ERROR_MESSAGES_USER, validators = [valida_5, valida_6])
  ...
  real_name = forms.CharField(label=_('Nombre real'),max_length=50, error_messages = ERROR_MESSAGES_GENERAL)
  email = forms.EmailField(max_length=30 , error_messages = ERROR_MESSAGES_EMAIL )
  social_id = forms.IntegerField(label=_('Codigo de borrado') ,error_messages = ERROR_MESSAGES_GENERAL, validators = [valida_2, valida_3, valida_4])
